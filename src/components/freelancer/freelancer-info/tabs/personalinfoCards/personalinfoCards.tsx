                                        ...
                                        {profile ? (
                                            <>
                                                <p className="flex items-center mb-2">
                                                    ...
                                                    <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700">
                                                        LinkedIn
                                                    </a>
                                                </p>
                                                <p className="flex items-center mb-2">
                                                    <Github className="mr-2" />
                                                    <a href={profile.github} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700">
                                                        GitHub
                                                    </a>
                                                </p>
                                                <p className="flex items-center mb-2 ">
                                                    <Globe className="mr-2" />
                                                    <a href={profile.personalWebsite} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700">
                                                        Personal Website
                                                    </a>
                                                </p>
                                            </>
